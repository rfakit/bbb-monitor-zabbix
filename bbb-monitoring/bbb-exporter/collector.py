...
class BigBlueButtonCollector:
    ...
    def collect(self):
        ...
        # logging.debug(json.dumps(meetings, indent=4))
        # logging.debug(json.dumps(meetings_data_latency, indent=4))
        # logging.debug(json.dumps(execution_duration(api.get_recordings)("published"), indent=4))
